				...
				%>
					...
					<div class="lfr-form-row" id="<portlet:namespace />fieldset<%= formFieldsIndex %>">
						<div class="row-fields">
							<liferay-util:include page="/html/edit_field.jsp" servletContext="<%= application %>" />
						</div>
					</div>
...
<p style="color:grey; font-size:.9rem; margin-top:2rem; text-align:right;">Web Form TJAGLCS 1.4.0</p>
